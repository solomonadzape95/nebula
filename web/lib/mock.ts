...
export interface FeedbackRow {
  id: string;
  /** Truncated wallet, or null when someone answered without connecting. */
  address: string | null;
  succeeded: boolean;
  clarity: 1 | 2 | 3 | 4 | 5;
...
export const FEEDBACK: FeedbackRow[] = [
  {
    ...
    confusedBy: "Took me a while to get that my nXLM number was supposed to stay the same. I thought the deposit had partly failed.",
    wouldAdd: "Show what my deposit is worth in the wallet, not just in the app.",
    at: "2026-07-27T18:12:00Z",
    actioned: "Added the 'never changes' label beside the nXLM row and the gold analogy to the landing page.",
  },
  {
    id: "f2",
    address: "GDPHDT44YGLSXXDHO7JFYPEUKVLNGT26PLYUE7LHOP7GPSPM23GDILPA",
    ...
    wouldAdd: "An estimate of what I'd earn over a month at the current rate.",
